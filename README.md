...
This repository also publishes a WebAssembly package to JSR as `@scarf005/conventional-prs`.
...
```bash
deno add jsr:@scarf005/conventional-prs
```

```ts
import { validateCommitHeader } from "@scarf005/conventional-prs"
